...
const Primary = Color(0xFFff9a8d);
const Secondary = Color(0xFF4a536b);
const ColorPrimaryDark = Color(0xFFFFF);

const TextColorPrimary = Color(0xFF070706);
const TextColorSecondary = Color(0xFF747474);
const TextColorWhite = Color(0xFFffffff);
const TextColorOrange = Color(0xFFF4413D);
const TextColorYellow = Color(0xFFff8c42);
const TextLightGreenColor = Color(0xFF8ed16f);

const app_Background = Color(0xFFf3f5f9);
const app_blackColor = Color(0xFF070706);
const app_view_color = Color(0XFFDADADA);
const app_blackLightColor = Color(0xFF242525);
const app_shadowColor = Color(0X95E9EBF0);
const app_greyColor = Color(0xFFA3A0A0);
const app_bottomEditTextLineColor = Color(0xFFDBD9D9);
const app_backgroundFragmentColor = Color(0xFFF7F5F5);
const app_palColor = Color(0xFF4a536b);
const app_BalanceColor = Color(0xFF8ed16f);
const app_whitePureColor = Color(0xFFffffff);
const app_subTitleColor = Color(0xFF5C5454);
const app_blueColor = Color(0xFF041887);
const app_blueLightColor = Color(0xFF41479B);
const app_pinkColor = Color(0xFFE91E63);
const app_RedColor = Color(0xFFD80027);
const app_greenLightColor = Color(0xFF05E10E);
const app_skyBlueColor = Color(0xFF03A9F4);
