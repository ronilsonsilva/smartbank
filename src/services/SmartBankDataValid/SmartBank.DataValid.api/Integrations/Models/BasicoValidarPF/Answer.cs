...
namespace SmartBank.DataValid.Api.Integrations.Models.BasicoValidarPF
{
    ...
    public class AnswerFacial
    {
        public AnswerFacial(string nome, string sexo, int nacionalidade, Filiacao filiacao, Documento documento, Endereco endereco, Cnh cnh, string dataNascimento, string situacaoCpf)
        {
            Nome = nome;
            Sexo = sexo;
            Nacionalidade = nacionalidade;
